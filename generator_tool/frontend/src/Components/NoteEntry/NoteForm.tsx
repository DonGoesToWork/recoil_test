...
const NoteForm: React.FC<NoteFormProps> = ({ selectedNote, updateNote, deleteNote }) => {
  return (
    <div className="note-view">
      ...
      <textarea className="note-content small" value={selectedNote.child_list} onChange={(e) => updateNote("child_list", e.target.value, selectedNote.id)} placeholder="Write one (1) child object per line..." />
