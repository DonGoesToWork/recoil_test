...
// functions to generate for each child object
...
let inventory_remove_rpg_item = (state: Backend_State, rpg_item_id: string, _inventory_id?: string | IO_Inventory): void => {
