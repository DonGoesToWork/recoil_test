import { IA_inventory_add_rpg_item, IA_inventory_remove_rpg_item, IO_Inventory } from "../z_generated/Shared_Data_Models/Inventory";
...
export const iam_inventory_add_rpg_item = (state: Backend_State, data: IA_inventory_add_rpg_item): void => {
  // Sample Snippets:
  // let inventory: IO_Inventory = inventory_get(state, data.inventory_id);
  // let rpg_item: IO_Rpg_Item = rpg_item_get(state, data.rpg_item_id);
